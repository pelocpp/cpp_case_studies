...
PartitionSet PartitionCalculator::calculate(int number)
{
    ...
    if (number == 1) {
        ...
        //// TODO: PeLo das muss mit einer Range Based Loop GEHEN !!!
        //for (int i = 0; i < setMinusOne.size(); i++) {

        //    std::vector<int> numbers = setMinusOne[i].numbers();
        ...
        //std::vector<int> ones(number, 1); // initialize with number elements set to the value 1
