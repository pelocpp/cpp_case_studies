...
namespace OriginalVersionModified {
    ...
    private:
        ...
        std::atomic<int> m_numForksInUse { 0 };
    ...
    public:
        ...
        void eating()
        {
...

            {
                ...
                Logger::log(std::cout, m_name, " started eating (at seat ", m_seat, ") [", m_table.numForks(), ']', " uses forks ", m_seat, " - ", (m_seat + 1) % 5);
        ...
        void eatingDone()
        {
            Logger::log(std::cout, m_name, " finished eating (at seat ", m_seat, ") ", "   released forks ", m_seat, " - ", (m_seat + 1) % 5);
        }
...
int main()
{
    ...
    DiningPhilosophersSimulation::simulation();
    //testRandom();
