...
//int PostfixCalculator::calc3(Scanner& scanner)
//{
...
//}
//
//int PostfixCalculator::calc2(std::list<Token>::iterator begin, std::list<Token>::iterator end)
//{
//    std::stack<Token> m_stack;  // temporary stack of operands
//
//// std::list<Token>::iterator it;
//
//    for (std::list<Token>::iterator it{ begin }; it != end; ++it)
